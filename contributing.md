...
- Fork the [project](https://github.com/openMF/paymenthub-ee-e2e-tests) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-e2e-tests.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-e2e-tests.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-e2e-tests.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-e2e-tests.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-e2e-tests.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-e2e-tests.git (push)
```
